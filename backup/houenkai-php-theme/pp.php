...
<section class="pp_main">
        <div class="pp_img">
          <img src="<?php echo get_template_directory_uri(); ?>/images/pp_img@2x.webp" alt="プライバシーポリシー" />
        </div>
        <div class="pp_text">
          <p>
            医療法人　芳縁会（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
          </p>
          <h2>第1条（個人情報）</h2>
          <p>
          ...
          <p>
            ...
            住所：宮城県仙台市青葉区八幡２丁目３−６グラシアスはちまん1F<br />
            社名：医療法人　芳縁会<br />
            Eメールアドレス：iwenting@houen-zaitaku.jp<br /><br>
